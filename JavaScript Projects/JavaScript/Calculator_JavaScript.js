...
const Calculator = {
    ...
    // this will hold the oeprator, we set it to null fo rnow
    operator: null,
};
...
function Input_Digit(digit) {
    ...
    // this overwrites Display_Value if the current value ir 0
...
function Input_Decimal(dot) {
    ...
    // doesn't cuse bugs in your operation
...
// this function updates teh screen with teh contents of Display_Value
...
keys.addEventListener('click', (event) => {
    //the target variable is an object that represents teh element
    //that was clicked
    const {target} = event;
